...
namespace DatabaseDefintion.Test
{
    ...
    public class DatabaseDefinitionTestBase
    {
        ...
        public async Task<TM.ItemPicture> CreateRandomItemPictureForNewItemAsync()
        {
            ...
            return new() { ItemId = ids.First(), Bytes = new byte[500], Description = $"TestDescription-{Guid.NewGuid()}", FileExtension = "png", Size = (decimal)(Random.Next(0, 1000000) + Random.NextDouble()) };
        }
